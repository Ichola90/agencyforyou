      ...
      <header
        ...
        <div className='container mx-auto flex items-center justify-between p-6'>
          ...
          <div className='flex items-center xl:gap-4 lg:gap-2 gap-2'>
            ...
            {/* Sign In — fond blanc avec texte darkprimary, hover fond darkprimary texte blanc */}
            <Link
              href='#'
              className='hidden lg:block bg-white border border-white text-darkprimary px-4 py-2 rounded-lg hover:bg-darkprimary hover:text-white hover:border-darkprimary transition-colors duration-[0.4s]'
            ...
            {/* Sign Up — fond LightApricot texte darkprimary, hover fond white texte darkprimary */}
            <Link
              href='#'
              className='hidden lg:block bg-LightApricot text-darkprimary px-4 py-2 rounded-lg hover:bg-white hover:text-darkprimary transition-colors duration-[0.4s]'
        ...
        <div
          ...
          <nav className='flex flex-col items-start p-4'>
            ...
            <div className='mt-4 flex flex-col gap-4 w-full'>
              {/* Sign In mobile — fond primary texte white, hover fond darkprimary */}
              <Link
                href='#'
                className='bg-primary text-white px-4 py-2 rounded-lg hover:bg-darkprimary transition-colors duration-[0.4s] text-center'
                onClick={() => {
              ...
              {/* Sign Up mobile — fond LightApricot texte darkprimary, hover fond primary texte white */}
              <Link
                href='#'
                className='bg-LightApricot text-darkprimary px-4 py-2 rounded-lg hover:bg-primary hover:text-white transition-colors duration-[0.4s] text-center'
                onClick={() => {
