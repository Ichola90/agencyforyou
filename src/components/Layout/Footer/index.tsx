                ...
                <div key={sectionKey} className={`${colSpan}`}>
                  ...
                  <ul>
                    {items.map((item) => (
                      <li
                        key={item.name}
                        className='text-base font-normal  leading-8 text-lightPrimary  hover:text-white transition-colors duration-[0.4s]'>
            ...
            <div className='col-span-3'>
              ...
              <div className='relative flex'>
                <input
                  ...
                  className='bg-transparent border border-dark_border border-solid py-3 pl-6 pr-14 rounded-lg focus:outline-0 text-lightPrimary hover:text-white transition-colors duration-[0.4s] w-full focus:border-primary'
              ...
              <p className='text-base font-normal text-lightPrimary  hover:text-white transition-colors duration-[0.4s] max-w-310 pt-3'>
                © Copyright 2025. All rights reserved by{' '}
                <Link
                  href={'https://ichtech.org/'}
