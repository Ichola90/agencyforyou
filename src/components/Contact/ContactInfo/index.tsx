          ...
          <div className='flex md:flex-row flex-col items-stretch justify-start sm:gap-28 gap-8'>
            <div className='flex sm:flex-row flex-col items-start sm:gap-8 gap-4'>
              ...
              <div>
                ...
                <p className='text-SlateBlue dark:text-darktext font-normal text-xl max-w-334 pt-3 pb-7'>
                ...
                <div>
                  <Link
                    href='#'
                    className='text-primary text-lg font-medium flex items-center gap-3 group hover:text-darkprimary dark:hover:text-white transition-colors duration-[0.4s]'>
                    Leave a message
